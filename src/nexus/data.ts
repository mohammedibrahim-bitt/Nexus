...
export const t: Record<string, { en: string; ar: string }> = {
  ...
  writeAccessRequired: {
    en: 'Log in to write blogs.',
    ar: 'سجّل الدخول لكتابة المدونات.',
  },
  ...
  deleteBlogConfirm: {
    en: 'Delete this blog? This cannot be undone.',
    ar: 'حذف هذه المدونة؟ لا يمكن التراجع عن هذا الإجراء.',
  },
  ...
  noBlogsYet: { en: 'No blogs published yet.', ar: 'لا توجد مدونات منشورة بعد.' },
}
